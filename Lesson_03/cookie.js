// Напишите функцию setCookie(name, value, days), которая устанавливат cookie с указанным именем,
...
setCookie('username', 'John Doe', 8);
setCookie('userinfo1', 'Mister X', 88);
setCookie('userinfo', 'Lord', 888);
